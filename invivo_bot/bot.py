...
REG_USERNAME = os.getenv("REG_USERNAME", "invivo_registratura")  # без @
...
def ask_llm(user_text: str, user_id: int) -> str:
    ...
    clinic_info = (
        ...
        "Har doim foydalanuvchiga muloyim, qisqa va o‘zbek tilida (lotin yozuvida) javob ber. "
        "Klinikamizda quyidagi yo‘nalishlar mavjud: Terapiya, Pediatriya, Nevrologiya, Ginekologiya, "
        ...
        "- Urinov Xurshid — Endokrinolog\n"
        "- Yefirova Rumiyaxon — Ginekolog\n"
        "- Madaminova Fotimaxon — UZI mutaxassisi\n"
        "- Foziljonov Raxmatjon — Nevropatolog\n"
        "- Dadaboyev Azizjon — Gastroenterolog\n"
        "- Urinova Irodaxon — Okulist\n"
        "Agar foydalanuvchi narxlar yoki analizlar haqida so‘rasa, shunga mos javob ber. "
        "Agar u shaxsiy sog‘lig‘i haqida so‘rasa, umumiy maslahat ber va shifokorga murojaat qilishni tavsiya et."
    )

    # 🧠 User tarixini saqlaymiz
    ...
    try:
        ...
        payload = {
            ...
            "messages": user_history[user_id][-8:],  # so‘nggi 8 xabarni yuboramiz
            "temperature": 0.3,
        }
        r = requests.post(
...
#najas taxlili buldi
   "Biokimyo": [
        ...
        ("Ovqatdan 2 soat o‘tib glyukoza", 40000),
       ...
       #("JIGAR TESTLARI"),
        ...
        ("To‘g‘ridan-to‘g‘ri bilirubin", 20000),
...
"Gormonlar (IHLA)": [
    ...
    ("SHBG (jinsiy gormon bog‘lovchi globulin)", None),
    ("Inhibin-B", None),
...
"Qon tahlillari": [
    ("Umumiy qon tahlili (21 ko‘rsatkich)", 45000),
    ("SOE — eritrotsit cho‘kish tezligi", 10000),
    ("Umumiy qon tahlili (gemoglobin, leykotsit SOE", 25000),
    ("Gemoglobin konsentratsiyasi(Hb)", 10000),
#то что исправил сверху
    ...
    ("RDW (eritrotsit hajmining o‘zgaruvchanligi)", None),
    ("PDW (trombotsit hajm o‘zgaruvchanligi)", None),
    ("PLCR — katta trombotsitlar nisbati", None),
    ("PCT — trombotsitli gematokrit", None),
...
DOCTORS = [
    {"id": "urinov", "name": "Endokrinolog \n: Urinov Xurshid",
     ...
     "experience": "10 лет", "schedule": "Dushanba-Juma 8:00 dan 18:00 gacha",
     "skills": ["✅ Reproduktolog","✅ Terapiya","✅ Profilaktika","✅ Konsultatsiya"]},
    {"id": "azizjon", "name": "Gastrentolog-Onkolog, ФГДС-mutaxasisi \n: Dadaboyev Azizjon",
     "photo": "https://i.postimg.cc/8cVmsnj8/66ee921c.jpg",
     "experience": "10 лет", "schedule": "Payshanba va Shanba kunlari 14:00 dan 17:00 gacha",
     "skills": ["✅ Analiz","✅ Profilaktika","✅ Konsultatsiya"]},
    {"id": "madaminov", "name": "Endokrinolog \n: Madaminov Murodjon",
     "photo": "https://i.postimg.cc/D02mG0dZ/4ab4f621.jpg",
     "experience": "2 лет", "schedule": "Dushanba-Shanba: 8:00 dan 18:00 gacha",
     "skills": ["✅ Terapiya","✅ Profilaktika","✅ Konsultatsiya"]},
    {"id": "soxibjon", "name": "Nevropotolog-gastrentolog, ФГДС-mutaxasisi \n: Muxamadaliyev Soxibjon",
     "photo": "https://i.postimg.cc/kgMwxZsp/1f12dbab.jpg",
     "experience": "10 лет", "schedule": "Dushanba-Shanba 14:00 dan 17:00 gacha",
     "skills": ["✅ Analiz","✅ Profilaktika","✅ Konsultatsiya"]},
    {"id": "urinova", "name": " Okulist \n: Urinova Irodaxon",
     "photo": "https://i.postimg.cc/L6Cby8wf/20357709.jpg",
     "experience": "8 лет", "schedule": "Dushanba/Shanba: 8:00-13:00",
     "skills": ["✅ Pediatriya","✅ Konsultatsiya","✅ Profilaktika"]},
    {"id": "foziljonov", "name": " Nevropatolog \n: Foziljonov Raxmatjon Xikmatjon o'g'li",
     "photo": "https://i.postimg.cc/QMWFLFbX/72e631e7.jpg",
     "experience": "15 лет", "schedule": "Yakshanba: 09:00-14:00",
     "skills": [
            "✅ Bosh miyyada qon aylanishi buzulishi (insult)","✅ Bel disk grijalari","✅ Boshdagi og'riq","✅ Batuloterapiya va Kosoartrozlarda gialuron kislatasini inyeksiyasi",
            "✅ Quloqlardagi sho'vqin","✅ Turli eplepsiya kasalliklari","✅ Nerf shamaloshi (nevralgiya)",
            "✅ Kuchli depresiya","✅ Asabiylik","✅ Boshdagi bosimni oshishi",
            "✅ Nerf impulslari bilan bog'liq muammolar","✅ Uyqusizlik","✅ Tanadagi ko'chib yuruvchi og'riqlar"
        ]},
    {"id": "rumiya", "name": "Genekolog\n: Yefirova Rumiyaxon",
     ...
     "skills": ["✅ Akusher-ginekolog","✅ Homiladorlikni kuzatish","✅ Ayollar sog'lig'i bo'yicha maslahatlar",
            "✅ Gormonal muvozanat buzilishi","✅ Reproduktiv salomatlik"]},
    {"id": "tashkentbayev", "name": "Stamotolog \n: Tashkenbayev Shoyatbek",
     "photo": "https://example.com/ahmedov.jpg",
     "experience": "20 лет", "schedule": "Sb-Vs: 11:00-17:00",
     "skills": ["✅ Качественные пломбы","✅ Импланты","✅ Бреккеты"]},
    {"id": "fotimaxon", "name": "UZI mutaxasis \n: Madaminova Fotimaxon ",
     "photo": "https://i.postimg.cc/VvBBtBC0/cd1ddd72.jpg",
     "experience": "10 лет", "schedule": "Pn-Sr-Pt: 08:30-15:00",
     "skills": ["✅ ЭХО-КГ ","✅ Барча кон томирлар доплероорафияси","✅ Корин бушлиги азолари ультратовуш текшируви","✅ Фолликулометрия ички ва ташки датчиклар ассосида","✅ Хомиладорликдаги скрининг ва нухсонли холатларни аниклаш"]},
]
...
def main_kb() -> ReplyKeyboardMarkup:
    rows = [
        [KeyboardButton(text="👨‍⚕️ Mutaxassislar")],
        [KeyboardButton(text="🧪 Laboratoriya analizlari"), KeyboardButton(text="🖥️ UZI")],
        [KeyboardButton(text="🕘 Ish vaqti"), KeyboardButton(text="📍 Manzil")],
        [KeyboardButton(text="🏥 Klinika haqida"), KeyboardButton(text="ℹ️ Ma'lumot")],
...
def doctors_kb() -> InlineKeyboardMarkup:
    ...
    if not rows:
        rows = [[InlineKeyboardButton(text="(Hozircha ro‘yxat bo‘sh)", callback_data="doc:list")]]
    return InlineKeyboardMarkup(inline_keyboard=rows)

def back_kb() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        inline_keyboard=[[InlineKeyboardButton(text="⬅️ Ro'yxatga qaytish", callback_data="doc:list")]]
    )
...
def doctor_caption(d: Dict[str, Any]) -> str:
    if d.get("id") == "foziljonov":
        return (
            "🔰Nevropatolog🔰\n\n"
            "Yuqori Malalali Shifokor :👨‍⚕️\n"
            "Nevropatolog 🧠 \n"
            "Foziljonov Raxmatjon Xikmatjon og'li.\n\n"
            "✅Bosh miyyada qon aylanishi buzulishi (insult)\n"
            "✅Bel disk grijalari \n"
            "✅Boshdagi og'riq\n"
            "✅Quloqlardagi sho'vqin\n"
            "✅Turli eplepsiya kasaliklari\n"
            "✅Nerf shamaloshi (nevralgiya)\n"
            "✅Kuchli depresiya \n"
            "✅Asabiylik \n"
            "✅Boshdagi bosimni oshishi \n"
            "✅Nerf impulslari bilan bog'liq muamolar\n"
            "✅Uyqusizlik \n"
            "✅Tanadagi ko'chib yuruvchi og'riqlar \n\n"
            "📅Ish vaqti: Yakshanba 09:00-14:00"
        )
    ...
    return (
        ...
        f"{skills_str}\n\n"
        f"📅 Ish vaqti: {jadval}\n"
        f"🧭 Tajriba: {tajriba.replace('лет', 'yil')}"
    )
...
def lab_category_text(cat_title: str) -> str:
    ...
    lines = [f"🧪 <b>{cat_title}</b>", "Quyidagi tahlillar va narxlar:"]
    for name, price in items:
        lines.append(f"• {name} — <b>{sums(price)}</b>")
    return "\n".join(lines)
...
def other_prices_kb() -> InlineKeyboardMarkup:
    ...
    if not rows:
        rows = [[InlineKeyboardButton(text="(Hozircha yo‘q)", callback_data="pricecat:none")]]
    return InlineKeyboardMarkup(inline_keyboard=rows)
...
async def send_price_category_message(m: Message, cat_title: str):
    if cat_title not in LAB_PRICES:
        ...
        return
    lines = [f"📂 <b>{cat_title}</b>", "Quyidagi xizmatlar:"]
    for name, val in LAB_PRICES[cat_title]:
        lines.append(f"• {name} — <b>{sums(val)}</b>")
    await m.answer("\n".join(lines))
...
def malumot_kb() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="▶️ Video (ko‘rish)", url=INSEM_VIDEO)]
    ])

async def show_insemination_info(m: Message):
    text = (
        "ℹ️ <b>Inseminatsiya haqida</b>\n\n"
        "Sun’iy urug‘lantirish (inseminatsiya) — spermani bevosita bachadon bo‘shlig‘iga kiritish orqali "
        "homiladorlik ehtimolini oshiruvchi usul.\n\n"
        "<b>Ko‘rsatmalar:</b>\n"
        "• Er-xotin bepushtligi (erkak faktor / servikal faktor)\n\n"
        "<b>Afzalliklari:</b>\n"
        "• Og‘riqsiz va tez\n"
        "• Qayta tiklanish davri talab qilinmaydi\n\n"
        "Videoni ko‘rib chiqing va savollaringiz bo‘lsa, yozing."
    )
    await m.answer(text, reply_markup=malumot_kb(), disable_web_page_preview=False)

# === BOOKING ===
def booking_info_text() -> str:
    at = f"@{REG_USERNAME}" if REG_USERNAME else "—"
    return (
        "📝 <b>Navbatga yozilish</b>\n"
        f"📞 <b>Registatura:</b> <b>{REG_PHONE}</b>\n"
        f"👤 <b>Telegram:</b> {at}\n\n"
...
async def notify_admin_booking(m: Message, source: str):
    ...
    full = user.full_name if user else "—"
    uid = user.id if user else "—"
    chat_link = f"tg://user?id={uid}" if uid != "—" else "—"
    try:
        await bot.send_message(
            ADMIN_ID,
            (
                "📥 <b>So‘rov: navbatga yozilish</b>\n"
                f"🧩 <b>Manba:</b> {source}\n"
                f"👤 {full} ({uname})\n"
                f"🆔 <code>{uid}</code>\n"
                f"🔗 {chat_link}"
...
@dp.message(
    ...
    (F.text.lower().contains("инсеминац"))
)
async def on_malumot(m: Message):
    await show_insemination_info(m)

# === LAB / UZI / PRICES HANDLERS ===
@dp.message(F.text == "🧪 Laboratoriya analizlari")
async def btn_lab(m: Message):
    await m.answer("🧪 Laboratoriya bo‘limlari:", reply_markup=lab_groups_kb())

@dp.message(F.text == "🖥️ UZI")
...
async def btn_prices(m: Message):
    if not OTHER_PRICE_CATS:
        await m.answer("Hozircha boshqa kategoriyalar yo‘q."); return
    await m.answer("💵 Narxlar bo‘limi. Kategoriyani tanlang:", reply_markup=other_prices_kb())
...
async def show_doctors(m: Message):
    await m.answer("👇 Shifokorni tanlang:", reply_markup=doctors_kb())

@dp.callback_query(F.data == "doc:list")
async def cb_list(q: CallbackQuery):
    await q.message.answer("👇 Shifokorni tanlang:", reply_markup=doctors_kb())
    await q.answer()
...
async def show_address(m: Message):
    ...
    address_text = (
        ...
        "To'qimachilar ko'chasi 55A uy (Tuman prokuraturasi orqasida)\n\n"
        "🌐 <a href='https://maps.google.com/maps?q=40.369926,71.268778&ll=40.369926,71.268778&z=16'>Google xaritada ochish</a>"
    )
    try:
...
@dp.message(F.text.lower().contains("клиник"))
...
async def show_about(m: Message):
    ...
    caption = (
        "🏥 <b>Invivo Clinic</b>\n\n"
        f"📍 <b>Manzil:</b> {esc(CLINIC['address'])}\n"
        "🩺 <b>Faoliyat yo'nalishlari:</b> Terapiya, Pediatriya, Nevrologiya, "
        ...
        f"🕘 <b>Ish vaqti:</b> {esc(CLINIC['hours'])}\n"
        "📞 <b>Aloqa uchun:</b> +998 99 302 32 31\n\n"
...
@dp.message(F.text == "📝 Navbatga yozilish")
...
async def private_router(m: Message):
    ...
    if any(k in t for k in ["врач","доктор","специалист","mutaxassis","shifokor","doktor"]):
        return await show_doctors(m)
    if any(k in t for k in ["расписан","время","график","ish vaqti","ish vaqt","jadval"]):
        return await show_hours(m)
    if any(k in t for k in ["адрес","локац","как пройти","manzil","lokatsiya","qanday borish","qanday boraman"]):
        return await show_address(m)
    if any(k in t for k in ["цен","стоим","прайс","narx","narxlar","qancha","qanchaga"]):
    ...
    if any(k in t for k in ["stomatolog", "stoma", "tish", "стоматолог", "зуб"]):
        return await send_price_category_message(m, "Stomatologiya")
    if any(k in t for k in ["ginekolog", "гинеколог", "ayol", "ayollar"]):
        return await send_price_category_message(m, "Ginekologiya")
    if any(k in t for k in ["uzi", "узи", "ultratovush", "ultra tovush"]):
        return await send_price_category_message(m, "UZI")
    if any(k in t for k in ["fgds", "egd", "endoskop", "endoskopiya", "kolonoskop", "kolonoskopiya", "колоноскопия", "фгдс"]):
        return await send_price_category_message(m, "Endoskopiya (FGDS/Kolonoskopiya)")
    if any(k in t for k in ["fizio", "fizioterapiya", "физиотерапия"]):
        return await send_price_category_message(m, "Fizioterapiya")
    if any(k in t for k in ["zuluk", "girudo", "пиявк", "гирудо"]):
        return await send_price_category_message(m, "Zuluk terapiyasi")
    if any(k in t for k in ["hijoma", "хиджама", "hijama"]):
        return await send_price_category_message(m, "Hijoma")
    if any(k in t for k in ["insemin", "inseminatsiya", "инсеминац"]):
        return await send_price_category_message(m, "Inseminatsiya")

    if any(k in t for k in ["klinika", "klinika haqida", "о клинике", "клиника"]):
        return await show_about(m)
    if any(k in t for k in ["navbat", "yozil", "запис", "qabul", "прием"]):
        await m.answer(booking_info_text())
...
def group_menu_kb() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="🧪 Lab analizlari", callback_data="g:lab"),
         InlineKeyboardButton(text="🖥️ UZI",             callback_data="g:uzi")],
        [InlineKeyboardButton(text="👨‍⚕️ Mutaxassislar", callback_data="g:doctors")],
        [InlineKeyboardButton(text="🕘 Ish vaqti",       callback_data="g:hours"),
         InlineKeyboardButton(text="📍 Manzil",          callback_data="g:addr")],
        [InlineKeyboardButton(text="🏥 Klinika haqida",  callback_data="g:about"),
         InlineKeyboardButton(text="💵 Narxlar",         callback_data="g:prices")],
        [InlineKeyboardButton(text="ℹ️ Ma’lumot (video)", callback_data="g:info")],
        [InlineKeyboardButton(text="📝 Navbatga yozilish", callback_data="g:book")],
    ])

@dp.callback_query(F.йata.startswith("g:"))
async def group_menu_router(q: CallbackQuery):
    ...
    try:
        if key == "doctors":
            ...
            await q.message.answer("🧪 Laboratoriya bo‘limlari:", reply_markup=lab_groups_kb())
        elif key == "uzi":
...
async def cmd_menu(m: Message):
    await m.answer("Bo‘limni tanlang:", reply_markup=group_menu_kb())

# === "menu"/"меню" текстом в группе ===
@dp.message((F.chat.type.in_({ChatType.GROUP, ChatType.SUPERGROUP})) & (F.text.regexp(r"(?i)^\s*/?menu\s*$|^\s*меню\s*$")))
async def txt_menu_group(m: Message):
    await m.reply("Bo‘limni tanlang:", reply_markup=group_menu_kb())
...
async def group_fallback_ai(m: Message):
    ...
    keyword_triggers = [
        ...
        "narx", "цен", "прайс",
        "navbat", "yozil", "запис", "qabul", "прием",
